				...
				<div v-if=isSettingsAvailable>
					...
					<div class="columns">
						...
						<div class="column">
							...
							<div v-for="item in availableSettings">
								<a class="button is-large" @click="selectImport(item)">
									<img v-if="item === 'niffler'" src="../assets/nifflerLogo.png" height="80" width="80">
									{{$t("msg.welcome.import")}} {{ item }}
        ...
        methods: {
            getState(){
				...
				if(configStatus.isConfigured){
                    ...
                    // if(configStatus.nifflerDetected) this.availableSettings.push('niffler') //NERF we are all using same dirs
                    // if(configStatus.diagonOldDetected) this.availableSettings.push('diagaonV1')
